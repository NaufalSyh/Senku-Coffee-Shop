...
$sql = "SELECT u.deskripsi, u.rating, usr.username, usr.photo_profil
FROM ulasan u
...
main.py-5.bg-light {
    background: linear-gradient(120deg, #fffbe9 80%, #e9d5b4 100%);
    border-radius: 18px;
...
<body>
            ...
            <div class="swiper-wrapper">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $foto_profil = !empty($row['photo_profil']) ? '../uploads/' . htmlspecialchars($row['photo_profil']) : 'https://ui-avatars.com/api/?name=' . urlencode($username) . '&background=deb887&color=fff';

                        echo '<div class="swiper-slide">';
                        echo '  <div class="card">';
                        echo '    <img src="' . $foto_profil . '" alt="Foto Profil" class="profil-ulasan mb-2">';
    ...
    <?php
$show_form = isset($_GET['tambah_ulasan']);
?>
<h3 style="text-align: center;">Berikan Ulasan Anda</h3>
<div class="text-center mb-3">
    <a href="?tambah_ulasan=1" class="btn btn-outline-success btn-ulasan" id="btnTambahUlasan" <?= $show_form ? 'style="display:none;"' : '' ?>>Tambah Ulasan</a>
</div>
<?php if ($show_form): ?>
<div class="form" id="formUlasan">
    <form action="simpan_ulasan.php" method="POST">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <button type="submit" class="btn btn-success btn-ulasan d-block mx-auto">Kirim</button>
            </div>
        </div>
    </form>
</div>
